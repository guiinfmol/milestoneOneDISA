...
select c.coursename, co.year, co.quartile FROM CourseOffersRegsAss cora, courseoffers co, courses c where 1.0*regs/50 > ass AND cora.courseofferid = co.courseofferid AND co.courseid = c.courseid order by cora.courseofferid;
